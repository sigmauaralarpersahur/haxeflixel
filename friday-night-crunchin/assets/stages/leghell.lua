...
function onCreate()
makeLuaSprite('abyss','leghell/abyss', -1000, -1000)
addLuaSprite('abyss',false)
setLuaSpriteScrollFactor('abyss',0.1,0.1)
scaleObject('abyss', 2, 2)

makeAnimatedLuaSprite('flames', 'leghell/FLAMESFLAMESBURNINGFLAMES', -700, -500)
...
makeLuaSprite('humor','leghell/humorbindings', -850, -850)
setLuaSpriteScrollFactor('humor',0.3,0.1)
scaleObject('humor', 2.1, 2.1)
addLuaSprite('humor', false)

makeLuaSprite('darkpillar','leghell/darkpillar', -1090, -1000)
setLuaSpriteScrollFactor('darkpillar',0.4,0.4)
scaleObject('darkpillar', 2.1, 2.1)
addLuaSprite('darkpillar',false)

makeLuaSprite('pillar','leghell/closerpillars', -850, -1000)
setLuaSpriteScrollFactor('pillar',1.5,1.5)
scaleObject('pillar', 2, 2)

makeLuaSprite('verynotclosepillars','leghell/farpillar', -1275, 500)
